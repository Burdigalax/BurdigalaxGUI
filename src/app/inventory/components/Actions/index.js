...
export default ({}) => (
  <Wrapper>
    <Bloc>
      ...
      />
      <EquippedButton
        iconLeftUrl={"https://image.flaticon.com/icons/svg/319/319248.svg"}
        variant={BTN_VARIANT.secondary}
        color={"#faa82a"}
      />
    </Bloc>
    <Bloc>
      ...
      <StyledSelect
        value={"Nabil Larechouille de la ratatouille"}
        input={<StyledInputBase />}
      >
        <MenuItem key={`quantity-`} value="Rom Burdi">
          Rom Burdi
        </MenuItem>
        <MenuItem
          key={`quantity-`}
          value="Nabil Larechouille de la ratatouille"
        >
          Nabil Larechouille de la ratatouille
        </MenuItem>
      </StyledSelect>
      <BurdiButtonAction
        iconLeftUrl={
